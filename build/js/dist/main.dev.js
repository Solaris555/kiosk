...
(function($) {
    ...
    var ssPreloader = function ssPreloader() {
        $WIN.on('load', function() {
            // force page scroll position to top at page refresh
            $('html, body').animate({
                scrollTop: 0
            }, 'normal'); // will fade out the whole preloader DIV that covers the website.
    ...
    var ssFitVids = function ssFitVids() {
    ...
    var ssOwlCarousel = function ssOwlCarousel() {
    ...
    var ssWaypoints = function ssWaypoints() {
    ...
    var ssPlaceholder = function ssPlaceholder() {
    ...
    var ssAjaxChimp = function ssAjaxChimp() {
        $('#mc-form').ajaxChimp({
            language: 'es',
    ...
    var ssBackToTop = function ssBackToTop() {
        var pxShow = 500,
            ...
            goTopButton = $("#go-top"); // Show or hide the sticky footer button
    ...
    (function ssInit() {
        ...
        ssAlertBoxes();
        ssAOS();
        ssBackToTop(); // to use the mailchimp form, uncomment the 
